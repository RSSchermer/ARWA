...
macro_rules! impl_scrollable_for_element {
    ($element:ident) => {
        ...
        impl $crate::scroll::Scrollable for $element {
            ...
            fn scroll_left(&self) -> f64 {
                ...
                self.as_web_sys_element().scroll_left() as f64
            }

            fn scroll_top(&self) -> f64 {
                use crate::dom::element_seal::Seal;

                self.as_web_sys_element().scroll_top() as f64
            }
            ...
            fn scroll_by(&self, options: $crate::scroll::ScrollByOptions) {
                ...
                self.as_web_sys_element()
                    .scroll_by_with_scroll_to_options(&opts);
            }
        }
    };
}
