...
impl HtmlTableElement {
    ...
    pub fn caption(&self) -> Option<HtmlTableCaptionElement> {
        self.inner
            .caption()
            .map(|c| HtmlTableCaptionElement::from(c))
    }
    ...
    pub fn get_or_create_caption(&self) -> HtmlTableCaptionElement {
        ...
        HtmlTableCaptionElement::from(caption)
    }
    ...
    pub fn table_head(&self) -> Option<HtmlTableSectionElement> {
        self.inner
            .t_head()
            .map(|c| HtmlTableSectionElement::from(c))
    }
    ...
    pub fn get_or_create_table_head(&self) -> HtmlTableSectionElement {
        let caption: web_sys::HtmlTableSectionElement = self.inner.create_t_head().unchecked_into();

        HtmlTableSectionElement::from(caption)
    }
    ...
    pub fn get_or_create_table_body(&self) -> HtmlTableSectionElement {
        let caption: web_sys::HtmlTableSectionElement = self.inner.create_t_body().unchecked_into();
    ...
    pub fn get_or_create_table_foot(&self) -> HtmlTableSectionElement {
        let caption: web_sys::HtmlTableSectionElement = self.inner.create_t_foot().unchecked_into();
    ...
    pub fn get(&self, index: usize) -> Option<HtmlTableSectionElement> {
        u32::try_from(index)
            ...
            .map(|e| {
                ...
                HtmlTableSectionElement::from(e)
            })
    }
...
impl<'a> TableRows<'a> {
    ...
    pub fn insert_new(&self, index: usize) -> Result<HtmlTableRowElement, RangeError> {
        self.table
            ...
            .map(|cell| {
                let cell: web_sys::HtmlTableRowElement = cell.unchecked_into();
